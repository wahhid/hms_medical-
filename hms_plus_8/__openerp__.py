{
	'name' : 'Odoo (OpenERP) Hospital Management System Plus',  
	'version' : '1.0',
	'author' : 'The Proven Technology',
	'category' : 'Generic Modules/Medical',
	'depends' : ['base','sale','purchase','account','product','hr'],
	'summary' : 'Complete Hospital Information System for Odoo platform',
	'description' : """

Hospital Management System (Plus) for Odoo
=======================================================
...
""",
	...
	"data" : ["hms_menu.xml","medical/medical_report.xml",
					"medical/medical_view.xml",					
